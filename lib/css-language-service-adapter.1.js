...
var CssLanguageServiceAdapter = (function () {
    function CssLanguageServiceAdapter(_helper, opt) {
        if (opt === void 0) { opt = {}; }
    ...
    CssLanguageServiceAdapter.prototype.getCompletionAtPosition = function (delegate, fileName, position) {
    ...
    CssLanguageServiceAdapter.prototype.getSemanticDiagnostics = function (delegate, fileName) {
        var _this = this;
    ...
    Object.defineProperty(CssLanguageServiceAdapter.prototype, "languageService", {
        get: function () {
    ...
    CssLanguageServiceAdapter.prototype.createTextDocumentForTemplateString = function (fileName, text, startOffset, startPosition) {
        var _this = this;
        var cssLanguageService = vscode_css_languageservice_1.getCSSLanguageService();
        return {
    ...
    return CssLanguageServiceAdapter;
}());
exports.CssLanguageServiceAdapter = CssLanguageServiceAdapter;
...
//# sourceMappingURL=css-language-service-adapter.1.js.map