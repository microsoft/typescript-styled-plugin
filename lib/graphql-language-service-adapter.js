...
var GraphQLLanguageServiceAdapter = (function () {
    ...
    Object.defineProperty(GraphQLLanguageServiceAdapter.prototype, "languageService", {
        get: function () {
    ...
    GraphQLLanguageServiceAdapter.prototype.createTextDocumentForTemplateString = function (fileName, text, startOffset, startPosition) {
        var _this = this;
        var cssLanguageService = vscode_css_languageservice_1.getCSSLanguageService();
        return {
