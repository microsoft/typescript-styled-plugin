...
var LanguageServiceAdapter = (function () {
    function LanguageServiceAdapter(_helper, opt) {
        if (opt === void 0) { opt = {}; }
    ...
    LanguageServiceAdapter.prototype.getCompletionAtPosition = function (delegate, fileName, position) {
    ...
    LanguageServiceAdapter.prototype.getSemanticDiagnostics = function (delegate, fileName) {
        var _this = this;
    ...
    Object.defineProperty(LanguageServiceAdapter.prototype, "languageService", {
        get: function () {
    ...
    LanguageServiceAdapter.prototype.createTextDocumentForTemplateString = function (fileName, text, startOffset, startPosition) {
        var _this = this;
        var cssLanguageService = vscode_css_languageservice_1.getCSSLanguageService();
        return {
...
//# sourceMappingURL=language-service-adapter.js.map